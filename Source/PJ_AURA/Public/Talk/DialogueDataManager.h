...
/**
 * Manager for loading and managing dialogue data
 */
...
public:
    ...
    UFUNCTION(BlueprintCallable, Category = "Dialogue Manager")
    void LoadDialogueDataFromTable(UDataTable* InDialogueDataTable);
    ...
    // Validation
    UFUNCTION(BlueprintCallable, Category = "Dialogue Manager")
    bool ValidateDialogueTree(const FDialogueTree& Tree) const;
